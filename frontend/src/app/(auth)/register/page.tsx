    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 border-r border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col justify-end p-12 text-white h-full pb-24">
          <h1 className="text-4xl font-bold mb-4 leading-tight">Gia nhập cộng đồng,<br/>Thỏa sức đam mê.</h1>
          <p className="text-lg text-slate-300 max-w-md">
            Tạo tài khoản ngay hôm nay để nhận được nhiều ưu đãi đặt sân và tham gia các giải đấu hấp dẫn.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[400px] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="phone">Số điện thoại <span className="text-muted-foreground font-normal">(Tùy chọn)</span></Label>
                <div className="relative">
              ...
              <Button type="submit" className="w-full h-12 text-base font-medium mt-6 shadow-md transition-all hover:shadow-lg" disabled={isLoading}>
                {isLoading ? (
                  <>
          ...
          <p className="text-center text-sm text-muted-foreground pt-4">
            Đã có tài khoản?{" "}
            <Link href={ROUTES.LOGIN} className="font-semibold text-primary hover:underline hover:text-primary/80 transition-colors">
              Đăng nhập ngay
            </Link>
          </p>
        </div>
