...
import com.pickleball.backend.security.jwt.AuthEntryPointJwt;
import com.pickleball.backend.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("*")); // For dev
